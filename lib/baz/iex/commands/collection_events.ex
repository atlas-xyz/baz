defmodule Baz.IEx.Commands.CollectionEvents do
  @moduledoc """
  ...
  @type opts :: Baz.CollectionEvents.filter_and_order_opts()
  ...
  def filter_and_order(opts) do
    opts
    |> Baz.CollectionEvents.filter_and_order()
    |> format_rows()
    |> render!(@header)
  end
  ...
  defp format_rows(instances) do
    ...
    |> Enum.map(fn i ->
      [
        i.event_timestamp |> DateTime.to_string(),
        i.venue,
        i.slug,
        i.token_id,
        i.event_type
