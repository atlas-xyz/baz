defmodule Baz.IEx.Commands.CollectionEventImportsTest do
  ...
  test "shows each collection event import" do
    ...
    assert capture_io(&Baz.IEx.collection_event_imports/0) == """
           +----------+-------+-----------------------------+-----------------------------+-----------+------------------------+-------------+--------+
           | Venue    | Slug  | Before                      | After                       | Token IDs | Types                  | Max Retries | Status |
           +----------+-------+-----------------------------+-----------------------------+-----------+------------------------+-------------+--------+
           | open_sea | azuki | 2022-01-20 12:00:05.123456Z | 2022-01-01 12:00:05.123456Z | 1, 2, 3   | item_listed, item_sold | 3           | active |
           +----------+-------+-----------------------------+-----------------------------+-----------+------------------------+-------------+--------+\n
           """
  end
